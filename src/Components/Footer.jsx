...
const Footer = () => {
  return (
    <footer className="text-center bg-[#2196f3] text-white sticky">
  ...
  <div className="text-center p-4" style={{backgroundColor: "rgba(0, 0, 0, 0.2)"}}>
    © 2021 Copyright:
    <a className="text-white" href="https://tailwind-elements.com/">  Christ the king International School</a>
  </div>
</footer>
  )
}
